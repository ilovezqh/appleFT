...
*		V1.1    2015-08-07 plxc  4K的缓冲区放到函数内部，使用堆栈空间，解决全局变量
*		
...
{
	/*
		普林芯驰STM32-V4 开发板口线分配：  串行Flash型号为 W25Q64BVSSIG (80MHz)
		PF8/SF_CS
	*/
...
void sf_ReadInfo(void)
{
	/* 自动识别串行Flash型号 */
	{
        ...
        case BY25Q128_ID:
            strcpy(g_tSF.ChipName, "BY25Q128");
            g_tSF.TotalSize = 16 * 1024 * 1024;	    /* 总容量 = 16M */
            g_tSF.SectorSize = 4 * 1024;		    /* 扇区大小 = 4K */
            break;		
