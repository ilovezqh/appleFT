...
/*
	该程序适用于普林芯驰STM32-X4、STM32-F4开发板
...
#ifdef STM32_X3		/* 普林芯驰 STM32-X4 开发板 */
	/*
		普林芯驰STM32-X4 LED口线分配：
	...
	*/
	...
	/*
		普林芯驰FT_F4 LED口线分配：
			LD1     : 绿       (低电平点亮，高电平熄灭)
			LD2     : 红       (低电平点亮，高电平熄灭)
			LD3     : 绿 按键  (低电平点亮，高电平熄灭)
			LD4     : 红 按键  (低电平点亮，高电平熄灭)
	*/

	/* 按键口对应的RCC时钟 */
	#define RCC_ALL_LED 	(RCC_AHB1Periph_GPIOB | RCC_AHB1Periph_GPIOD | RCC_AHB1Periph_GPIOE)

	#define GPIO_PORT_LED1  GPIOD        //绿
