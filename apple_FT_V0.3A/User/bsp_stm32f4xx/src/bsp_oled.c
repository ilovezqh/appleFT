...
*	文件名称 : bsp_oled.c
*	版    本 : V1.0
*	说    明 : OLED 屏(128x64)底层驱动程序，驱动芯片型号为 SSD1306.  本驱动程序适合于FT_F4开发板.
*				OLED模块挂在FSMC总线上。
*	修改记录 :
*		版本号  日期        作者    说明
*		V1.0    2013-02-01 plxc  正式发布
*
*	Copyright (C), 2010-2012, 普林芯驰 www.spacetouch.co
*
*********************************************************************************************************
*/
...
/*
	普林芯驰FT_F4开发板的OLED显示接口为FSMC总线模式。
*/
...
//#define DIR_180				/* 此行表示翻转180度 */
	...
	*/
	...
	/*
	1.普林芯驰OLED模块 80XX 模式接线定义 (需要15根杜邦线连接）
	   【OLED模块排针】 【开发板TFT接口（STM32口线）】
		    VCC ----------- 3.3V
		    GND ----------- GND
		     CS ----------- NCS
