...
*	修改记录 :
*		版本号  日期        作者    说明
*       v1.0    2012-07-06 plxc  ST固件库V3.5.0版本。
*		v1.1    2012-10-22 plxc  增加4点校准
*		v1.2    2012-11-07 plxc  解决4点校准的XY交换分支的bug
*		v1.3    2012-12-17 plxc  触摸校准函数增加入口参数:等待时间
*		V1.4    2013-07-26 plxc  更改 TOUCH_DataFilter() 滤波算法
*		V1.5    2013-07-32 plxc  修改TOUCH_WaitRelease(),计数器需要清零
*
...
/*
【1】普林芯驰STM32-X2开发板 + 3.0寸显示模块， 显示模块上的触摸芯片为 TSC2046或其兼容芯片
	PA8   --> TP_CS
	PD3   --> TP_BUSY
	PA5   --> TP_SCK
	PA6   --> TP_MISO
...
【2】普林芯驰STM32开发板 + 4.3寸或7寸显示模块（内置RA8875芯片)
...
{
/*
【1】普林芯驰STM32-X2, X4 开发板 + 3.0寸显示模块， 显示模块上的触摸芯片为 TSC2046或其兼容芯片
	PA8   --> TP_CS
	PD3   --> TP_BUSY
	PA5   --> TP_SCK
	PA6   --> TP_MISO
