...
*	文件名称 : bsp_wm8978.h
*	版    本 : V1.0
*	说    明 : WM8978音频芯片和STM32 I2S底层驱动。在普林芯驰FT_F4开发板上调试通过。
*
*	修改记录 :
*		版本号  日期        作者     说明
*		V1.0    2013-02-01 plxc  正式发布
*		V1.1    2013-06-12 plxc  解决单独Line 输入不能放音的问题。修改 wm8978_CfgAudioPath() 函数
*		V1.1    2013-07-14 plxc  增加设置Line输入接口增益的函数： wm8978_SetLineGain()
*
...
*						普林芯驰开发板硬件不支持 I2S_Mode_SlaveTx、I2S_Mode_SlaveRx 模式，这需要WM8978连接
*						外部振荡器
*	返 回 值: 无
*********************************************************************************************************
*/
