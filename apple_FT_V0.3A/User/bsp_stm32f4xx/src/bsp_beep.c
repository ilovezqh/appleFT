...
*	修改记录 :
*		版本号  日期        作者     说明
*		V1.0    2014-10-20 plxc  正式发布
*		V1.1    2015-10-06 plxc  增加静音函数。用于临时屏蔽蜂鸣器发声。
*
*	Copyright (C), 2015-2020, 普林芯驰 www.spacetouch.co
*
*********************************************************************************************************
*/
...
#define BEEP_HAVE_POWER		/* 定义此行表示有源蜂鸣器，直接通过GPIO驱动, 无需PWM */
	...
	/* PA8 */
	#define GPIO_RCC_BEEP   RCC_AHB1Periph_GPIOD
...
*	函 数 名: BEEP_Start
*	功能说明: 启动蜂鸣音。
*	形    参: _usBeepTime : 蜂鸣时间，单位10ms; 0 表示持续鸣叫
*			  _usStopTime : 停止时间，单位10ms; 0 表示不鸣叫
